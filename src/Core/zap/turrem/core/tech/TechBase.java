...
public abstract class TechBase extends Tech
{
	 ...
	 * @return Is the player have an entry point into the tech tree through this tech
	 */
	...
	/**
	 * This methoud calls loadBranches() before doing the branch calculations common to all techs. This method should always be called instead of loadBranches
	 * @param pass The pass number, differentiates between techs that also use this class
	 */
