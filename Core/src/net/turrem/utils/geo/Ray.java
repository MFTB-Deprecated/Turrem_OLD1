...
public class Ray
{
	...
	/**
	 * Moves the end point so that the ray has a given length but leaves the starting point stationary and maintains the same vector.
	...
	/**
	 * Increases the length of the ray by a given amount, leaving the starting point stationary and maintaining the same vector.
	...
	/**
	 * Increases the length of the ray by a given amount, leaving the end point stationary and maintaining the same vector.
	 * @param length The amount to increase the length of this ray
	 * @return This ray scaled
	 */
	...
	/**
	 * Scales this ray by the given ratio, leaving the starting point stationary.
	 ...
	 * @param loc The length from the starting point of this ray to the new point along this ray divided by the length of this ray. A value of 0.0 would give the starting point, 1.0 would give the ending point, 0.5 would give the average of the two, etc. 
